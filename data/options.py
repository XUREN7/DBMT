...
def option():
    # Training settings
    parser = argparse.ArgumentParser(description='CNM')
    ...
    parser.add_argument('--start_epoch', type=int, default=460, help='number of epochs to start, >0 is retrained a pre-trained pth')
