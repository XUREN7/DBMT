...
class DBMT(nn.Module):
    ...
    def forward(self, x):
        ...
        i_down_2 = self.I_down_LCA1(i_down_1, hv_down_1)
        hv_down_2 = self.HV_down_LCA1(hv_down_1, i_down_1)
        v_jump1 = i_down_2
        hv_jump1 = hv_down_2
        ...
        i_down_3 = self.I_down_LCA2(i_down_2, hv_down_2)
        hv_down_3 = self.HV_down_LCA2(hv_down_2, i_down_2)
        v_jump2 = i_down_3
        hv_jump2 = hv_down_3
        ...
        i_down_4 = self.I_down_LCA3(i_down_3, hv_down_3)
        hv_down_4 = self.HV_down_LCA3(hv_down_3, i_down_3)

        # CV_bottleNeck
        i_down_4 = self.I_up_MTMixer3(i_down_4, "I")
        hv_down_4 = self.HV_up_MTMixer3(hv_down_4, "HV")
        hv_up_4 = self.HV_up_LCA3(hv_down_4, i_down_4)
        i_up_4 = self.I_up_LCA3(i_down_4, hv_down_4)
        ...
        hv_up_3 = self.HV_up_LCA2(hv_up_4, i_up_4)
        i_up_3 = self.I_up_LCA2(i_up_4, hv_up_4)
        ...
        hv_up_2 = self.HV_up_LCA1(hv_up_3, i_up_3)
        i_up_2 = self.I_up_LCA1(i_up_3, hv_up_3)
