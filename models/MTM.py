...
class HV_CAB(nn.Module):
    def __init__(self, dim, num_heads, bias=False):
        super(HV_CAB, self).__init__()
...
class I_CAB(nn.Module):
    def __init__(self, dim, num_heads, bias=False):
        super(I_CAB, self).__init__()
...
class HVI_MTMixer(nn.Module):
    def __init__(self, dim):
        ...
        self.norm1 = LayerNorm(dim)
        self.mixer = Mamba(d_model=dim, d_state=8, d_conv=3, expand=1)
